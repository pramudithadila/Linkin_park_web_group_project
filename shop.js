...
function addToCartClicked(event) {
    ...
    var title = storeItem.getElementsByClassName('shop-item-title')[0].innerText
    var price = storeItem.getElementsByClassName('shop-item-price')[0].innerText
    var imageSrc = storeItem.getElementsByClassName('shop-item-image')[0].src
